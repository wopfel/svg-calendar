...
sample-calendar.svg: svg-calendar.pl $(data_files) $(perl_modules)
	perl svg-calendar.pl -year 2021 -weekmarker week_markers.txt -daymarker day_markers.txt -highlightdays highlight_days.yml -vacation vacation.yml > sample-calendar.svg
